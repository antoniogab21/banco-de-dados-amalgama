    ...
    useState<Message[]>([
      {
        ...
        company: 'Mercado Central',
        message:
          'Pessoal, alguém está precisando de arroz?',
        time: '10:30',
        isOwn: false,
      },
